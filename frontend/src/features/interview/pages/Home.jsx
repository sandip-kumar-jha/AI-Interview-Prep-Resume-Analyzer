    ...
    const handleGenerateReport = async () => {
        try {
            ...
            if (!resumeFile && !selfDescription.trim()) {
                alert(
                    "Please upload a PDF resume or enter your self-description."
                );
                return;
            }
            ...
            if (!data?._id) {
                ...
                alert(
                    "Interview report could not be generated. Please check the backend terminal."
                );
        ...
        <div className="home-page">
            ...
            <header className="page-header">
                ...
                <p>
                    ...
                    and your unique profile to build a winning
                    strategy.
                </p>
...
e.g. "Senior Frontend Engineer requires proficiency in React, JavaScript, TypeScript and system design..."`}
                            maxLength={5000}
                        />
